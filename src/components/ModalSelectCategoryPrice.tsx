...
const ModalSelectCategoryPrice = ({
	...
	const [itemPriceSelectedId, setItemPriceSelectedId] = useState<string>(priceSelectedId)
...
export const ModalSelectCategoryPriceE = (props: ModalSelectCategoryPriceProps) => (
