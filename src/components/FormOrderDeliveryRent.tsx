					...
					<View style={styles.form}>
						...
						{values.type !== order_type.STORE_RENT && (
							<>
								...
								<View style={[styles.item]}>
									<FormikInputValue name={'neighborhood'} placeholder="Colonia" />
								</View>
								<View style={[styles.item]}>
									<FormikInputValue
										name={'address'}
								...
								<View style={[styles.item]}>
									<FormikInputValue name={'references'} placeholder="Referencias de la casa" />
								</View>
							</>
						)}
						...
						<View style={[styles.item]}>
							{values.type === order_type.REPAIR && (
								<View>
									...
									/>
									<FormikInputValue name={'itemSerial'} placeholder="Numero de serie" />
								</View>
							)}
							{values.type === order_type.STORE_RENT && (
								<>
						...
						{values.type !== order_type.STORE_RENT && (
							<>
								...
								<View style={[styles.item, { justifyContent: 'center', width: '100%' }]}>
