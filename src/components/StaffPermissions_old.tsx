...
const StaffPermissions = ({ staff, storeId }: { staff: StaffType; storeId: string }) => {
	const permissions = Object.keys(staff_permissions)
	const allowedPermissions = permissions?.filter(permission => staff?.[permission])
...
export const StaffPermissionsE = (props: { staff: StaffType; storeId: string }) => {
	return (
