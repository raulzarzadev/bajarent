...
const PhoneLogin = () => {
	...
	return (
		<View style={{ padding: 4 }}>
			{!msmSent && (
				<>
					...
					<View style={styles.form}>
						...
						{!!error && (
							<View>
								<Text style={{ textAlign: 'center', color: theme.error }}>{error}</Text>
							</View>
						)}
						<View style={styles.item}>
							<Button onPress={onSignInSubmit} disabled={!validPhone || sending}>
								Enviar
							</Button>
						</View>
						<Button
			...
			{!!msmSent && (
				<>
					<Text style={styles.title}>Ingresa el codigo que te enviamos por SMS</Text>
					<View style={styles.form}>
						<View style={styles.item}>
						...
						<View style={styles.item}>
							<Button onPress={onSendCode} disabled={sending} label="Envíar"></Button>
						</View>
						<View style={styles.item}>
							<Button
								onPress={() => {
