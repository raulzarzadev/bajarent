	...
	return (
		<ScrollView>
			<View style={{ margin: 'auto', maxWidth: 400, marginVertical: 40 }}>
				<InputDatesRage defaultValues={dates} onChange={setDates} disabled={loading} />
			</View>
...
export const ListCustomBalances = () => {
	...
	return (
		<View style={{ width: '100%', margin: 'auto' }}>
			...
			/>
			{limitFound && <Text style={[gStyles.helper, gStyles.tCenter]}>*No hay mas registros</Text>}
			<Button
				onPress={() => {
					handleGetMore()
				}}
...
export const RowCustomBalance = (props?: RowCustomBalanceProps) => {
	...
	return (
		...
		>
			...
			<Text style={{ width: '15%' }}>{dateFormat(asDate(balance?.toDate), 'dd/MM/yy HH:mm')}</Text>
