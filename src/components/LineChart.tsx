					...
					>
						<View
							style={{
								width: 20,
								height: 20,
								backgroundColor: visibleData.includes(label) ? color : 'transparent',
								borderWidth: 1,
								borderColor: visibleData.includes(label) ? 'transparent' : color,
								borderRadius: 10,
								marginRight: 10
							}}
						></View>
				...
				data={{
					...
					datasets:
						datasets.map(({ data, color, label }) => ({
							data,
							color: () => (visibleData.includes(label) ? color : 'transparent'),
							withDots: false,
							strokeWidth: 3
						})) || []
				}}
