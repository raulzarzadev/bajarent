...
import CancelAlarm from './icon-clock-cancel'
import ClockDone from './icon-clock-done'
import ClockSwap from './icon-clock-swap'
import ClockWarning from './icon-clock-warning'
...
const icons = {
	...
	orderAsk: IconOrder,
	// pedido validado
	orderCanceled: IconOrderRemove,
	// pedido rechazado -> orden cancelada
	orderDelivered: IconOrderDone,
	// pedido en proceso de entrega
	orderInProcess: IconOrderEdit,
	// pedido entregado
	orderOnTheWay: IconOrderGo,
	// pedido recogido por el repartidor
	orderScheduled: IconOrderList
} as const
