export function BackupOutlineBadged(props) {
	return (
		<svg {...props} xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 36 36">
			...
			<path
				fill="currentColor"
				d="M30.87 13.45a8 8 0 0 1-.87.05a7.46 7.46 0 0 1-3.35-.8a3 3 0 0 1-.24 1.3h2.54c1.05 2.94 2.77 7.65 3.05 8.48V30H4v-7.52C4.28 21.65 7.05 14 7.05 14h2.53a3 3 0 0 1-.14-2H7.07a1.92 1.92 0 0 0-1.9 1.32C2 22 2 22.1 2 22.33V30a2 2 0 0 0 2 2h28a2 2 0 0 0 2-2v-7.67c0-.23 0-.33-3.13-8.88"
